...
점수가 가장 높은 사람이 게임의 승자가 됩니다. 여러분이 hopscotch 함수를 제작하여 영희가
최대 몇 점을 얻을 수 있는지 알려주세요. 예를 들어
1 2 3 5
5 6 7 8
4 3 2 1
...
let board = [[ 1, 2, 3, 5 ], [ 5, 6, 7, 8 ], [ 4, 3, 2, 1], [ 5, 6, 7, 9 ], [ 4, 3, 2, 1], [ 4, 3, 2, 1]];
console.log(hopscotch(board, 6));