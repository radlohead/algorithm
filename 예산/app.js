...
// 4. 물품을 구매해 줄 수 있는 부서 개수의 최댓값을 return 하세요.

// 입출력 예
// budgets	M	return
// [30000, 90000, 10000, 5000]	200,000

function solution(budgets, M) {
    let answer = 0;
    let result = 0;
    const arr = budgets.sort((a,b) => a-b);
    ...
    if (result <= M) answer = arr.length;
    return answer;
}

solution([20000, 100000, 100000, 50000], 200000);